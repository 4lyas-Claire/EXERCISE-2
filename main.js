...
function sortRecords() {
    ...
    if(sortNames.value == "" || sortAlphabetical.value == "") {
        return;
    }


    if(sortNames.value == "firstName") {


        if(sortAlphabetical.value == "asc") {
        ...
        else if(sortAlphabetical.value == "desc") {
    ...
    else if(sortNames.value == "lastName") {
